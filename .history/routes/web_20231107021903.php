...
Route::delete('/deletecover/{id}', [PostController::class, 'deletecover'])->name('album.destroy');
Route::delete('/destroyimage/{id}', [PostController::class, 'destroymultiimage'])->name('album.destroy');
Route::delete('/deletecover/{id}', [PostController::class, 'destroycover'])->name('album.destroy');
