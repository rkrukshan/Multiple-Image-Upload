            ...
            <div class="card">
                ...
                <div class="card-body">
                   ...
                   <form action="" method="post" enctype="multipart/form-data">
                    ...
                    <label for="bode">Title</label>
                    <textarea name="body" id="body" cols="20" rows="4"></textarea><br>
                    <label for="m-2">Cover Image</label>
                    <input type="file" id="input-file-now-custom-3" class="form-control m-2" name="cover" multiple>
